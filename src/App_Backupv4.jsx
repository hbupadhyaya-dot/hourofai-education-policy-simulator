...
const ImpactExplanationModal = ({ isOpen, onClose, selectedPolicies, policyIntensities }) => {
  ...
  const synergyDefs = {
    ...
    'PD_FUNDS+AI_CAREER_PATH': { EMPLOYMENT_IMPACT: 0.25, TEACHER_SATISFACTION: 0.1 },
    ...
    'INFRA_INVEST+AI_CAREER_PATH': { EMPLOYMENT_IMPACT: 0.25, AI_LITERACY: 0.15 },
    ...
    'AI_CAREER_PATH+LOCAL_JOB_ALIGN': { EMPLOYMENT_IMPACT: 0.3, INNOVATION_INDEX: 0.15 },
    'AI_CAREER_PATH+INNOV_SANDBOX': { EMPLOYMENT_IMPACT: 0.25, AI_LITERACY: 0.15 },
  ...
  const tensionDefs = {
    ...
    'AI_CAREER_PATH+COMM_INPUT': { EMPLOYMENT_IMPACT: -0.05, COMMUNITY_TRUST: -0.05 },
    'AI_CAREER_PATH+EDUC_AUTONOMY': { TEACHER_SATISFACTION: -0.1 },
    'AI_CAREER_PATH+DIGITAL_CITIZEN': { AI_LITERACY: -0.05 },
...
function App() {
  ...
  const [policyIntensities, setPolicyIntensities] = useState({
    DATA_ANALYTICS: 50,
    PROTECT_STD: 70,     // Starting point: 70%
    PD_FUNDS: 25,        // Starting point: 25%
    EDUC_AUTONOMY: 50,
    AI_CAREER_PATH: 2,   // Starting point: 2 hrs
    DIGITAL_CITIZEN: 15, // Starting point: 15%
    COMM_INPUT: 50,
    IMPACT_REP_STD: 50,
    LOCAL_JOB_ALIGN: 50,
    INTEROP_STD: 50,
    INFRA_INVEST: 10,    // Starting point: 10%
    ACCESS_STD: 65,      // Starting point: 65%
    STATE_FED_PART: 10,  // Starting point: $10M
    INNOV_SANDBOX: 45,   // Starting point: 45
    MODEL_EVAL_STD: 65   // Starting point: 65
  })
  ...
  // Update metrics when policies or intensities change - SAFE VERSION
  useEffect(() => {
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              <button
                ...
                className="px-3 py-2 border border-slate-200 rounded text-sm cursor-pointer focus:ring-1 focus:ring-slate-400 focus:border-slate-400 bg-white/90 backdrop-blur-sm hover:bg-slate-50 transition-colors flex items-center space-x-2"
              >
                <span>Why these impacts</span>
              </button>
              <button
                onClick={handleReset}
                        ...
                        <div className="flex items-center space-x-2">
                          <div className="relative">
                            <details className="relative">
                              ...
                              <div className="absolute right-0 top-full mt-1 bg-white border border-slate-200 rounded-lg shadow-lg z-20 min-w-48 p-2">
                                <div className="space-y-1">
                                  {Object.entries(policyDefinitions).map(([policyId, policy]) => (
                                    <label key={policyId} className="flex items-center space-x-2 cursor-pointer hover:bg-slate-50 rounded px-2 py-1">
                                      <input
                                        type="checkbox"
                                        checked={selectedPolicies.includes(policyId)}
                                        onChange={(e) => handlePolicyToggle(policyId)}
                                        className="w-3 h-3 rounded border-slate-300 text-slate-600 focus:ring-1 focus:ring-slate-400"
                                      />
                            ...
                            <div className="space-y-0.5">
                              <div className="relative">
                                  ...
                                  style={
                                    policyIntensities[policy.id] !== undefined ? {
                                      background: (() => {
                                        ...
                                        const center = policy.id === 'DATA_ANALYTICS' ? 50 : 
                                                     policy.id === 'PROTECT_STD' ? 72 : 
                                                     policy.id === 'PD_FUNDS' ? 25 : 50;
                                        if (value > center) {
                                ...
                                <div 
                                  ...
                                  style={{
                                    left: `${policy.id === 'DATA_ANALYTICS' ? 50 : 
                                           policy.id === 'PROTECT_STD' ? 72 : 
                                           policy.id === 'PD_FUNDS' ? 25 : 50}%`
                                  }}
                                ></div>
                                ...
                                <div className="flex justify-center mt-1">
                                  <div className="flex items-center justify-center">
                                    <input
                                      ...
                                      value={
                                        policy.id === 'DATA_ANALYTICS' ? (policyIntensities[policy.id] !== undefined ? policyIntensities[policy.id] : 50) :
                                        policy.id === 'PROTECT_STD' ? (policyIntensities[policy.id] !== undefined ? policyIntensities[policy.id] : 72) :
                                        policy.id === 'PD_FUNDS' ? Math.round(((policyIntensities[policy.id] !== undefined ? policyIntensities[policy.id] : 25)) * 1) :
                                        (policyIntensities[policy.id] !== undefined ? policyIntensities[policy.id] : 50)
                                      }
                                      onChange={(e) => {
                                        const raw = Number(e.target.value);
                                        let newIntensity = 50;
                                        if (policy.id === 'DATA_ANALYTICS') {
                                          newIntensity = raw; // 0-100 -> intensity 0-100
                                      ...
                                      min={policy.id === 'DATA_ANALYTICS' ? 0 : 0}
                                      max={policy.id === 'DATA_ANALYTICS' ? 100 : 100}
                                      step={1}
                                    />
                                    <span className="text-xs text-slate-500 ml-1">
                                      {policy.id === 'DATA_ANALYTICS' ? '' : policy.id === 'PD_FUNDS' ? 'hrs' : policy.id === 'PROTECT_STD' ? '%' : ''}
                                    </span>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div className="space-y-0.5">
                              <div className="relative">
                                <input
                                  type="range"
                                  min="0"
                                  max={policy.id === 'AI_CAREER_PATH' ? 10 : policy.id === 'DIGITAL_CITIZEN' ? 100 : 100}
                                  value={policyIntensities[policy.id] !== undefined ? policyIntensities[policy.id] : 
                                         policy.id === 'AI_CAREER_PATH' ? 2 : 
                                         policy.id === 'EDUC_AUTONOMY' ? 50 : 
                                         policy.id === 'DIGITAL_CITIZEN' ? 15 : 50}
                                  onChange={(e) => {
                                    const raw = Number(e.target.value);
                                    let newIntensity = 50;
                                    if (policy.id === 'AI_CAREER_PATH') {
                                      newIntensity = raw; // 0-10 (direct mapping)
                                    } else if (policy.id === 'EDUC_AUTONOMY' || policy.id === 'DIGITAL_CITIZEN') {
                                  ...
                                  style={
                                    policyIntensities[policy.id] !== undefined ? {
                                      background: (() => {
                                        ...
                                        if (policy.id === 'AI_CAREER_PATH') {
                                          center = 2; // 2 hours
                                          maxValue = 10; // 0-10 range
                                        } else if (policy.id === 'EDUC_AUTONOMY') {
                                          center = 50; // 50%
                                          maxValue = 100; // 0-100 range
                                ...
                                <div 
                                  className="absolute top-1/2 transform -translate-y-1/2 w-0.5 h-4 bg-slate-400 pointer-events-none"
                                  style={{
                                    left: `${policy.id === 'AI_CAREER_PATH' ? 20 : 
                                           policy.id === 'EDUC_AUTONOMY' ? 50 : 
                                           policy.id === 'DIGITAL_CITIZEN' ? 15 : 50}%`
                                  }}
                                ></div>
                              ...
                              <div className="relative">
                                <div className="flex justify-between text-xs text-slate-500">
                                  <span>{policy.id === 'AI_CAREER_PATH' ? '0' : '0'}</span>
                                  <span>{policy.id === 'AI_CAREER_PATH' ? '10' : '100'}</span>
                                </div>
                                <div className="flex justify-center mt-1">
                                  <div className="flex items-center justify-center">
                                    <input
                                      ...
                                      value={
                                        policy.id === 'AI_CAREER_PATH' ? (policyIntensities[policy.id] !== undefined ? policyIntensities[policy.id] : 2) :
                                        policy.id === 'EDUC_AUTONOMY' ? (policyIntensities[policy.id] !== undefined ? policyIntensities[policy.id] : 50) :
                                        policy.id === 'DIGITAL_CITIZEN' ? (policyIntensities[policy.id] !== undefined ? policyIntensities[policy.id] : 15) :
                                        (policyIntensities[policy.id] !== undefined ? policyIntensities[policy.id] : 50)
                                      }
                                      onChange={(e) => {
                                        const raw = Number(e.target.value);
                                      ...
                                      min={0}
                                      max={policy.id === 'AI_CAREER_PATH' ? 10 : 100}
                                      step={1}
                                    />
                                    <span className="text-xs text-slate-500 ml-1">
                                      {policy.id === 'AI_CAREER_PATH' ? 'hrs' : policy.id === 'EDUC_AUTONOMY' || policy.id === 'DIGITAL_CITIZEN' ? '%' : ''}
                                    </span>
                                  </div>
                                </div>
                              </div>
                                    ...
                                    <input
                                      ...
                                      value={
                                        policy.id === 'COMM_INPUT' ? Math.round(((policyIntensities[policy.id] !== undefined ? policyIntensities[policy.id] : 50)) * 0.24) :
                                         policy.id === 'IMPACT_REP_STD' ? (policyIntensities[policy.id] !== undefined ? policyIntensities[policy.id] : 50) :
                              ...
                              <div className="relative">
                                <input
                                  ...
                                  value={policyIntensities[policy.id] !== undefined ? policyIntensities[policy.id] : 
                                         ...
                                         policy.id === 'INFRA_INVEST' ? 10 : 
                                         policy.id === 'ACCESS_STD' ? 65 : 50}
                                  onChange={(e) => handlePolicyIntensityChange(policy.id, parseInt(e.target.value))}
                                  ...
                                  <div className="flex items-center justify-center">
                                    <input
                                      ...
                                      value={
                                        ...
                                        policy.id === 'INFRA_INVEST' ? (policyIntensities[policy.id] !== undefined ? policyIntensities[policy.id] : 10) :
                                        policy.id === 'ACCESS_STD' ? (policyIntensities[policy.id] !== undefined ? policyIntensities[policy.id] : 65) :
                                        (policyIntensities[policy.id] !== undefined ? policyIntensities[policy.id] : 50)
                                      }
                                      onChange={(e) => {
                                        const raw = Number(e.target.value);
