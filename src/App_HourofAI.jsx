...
function App() {
  ...
  const getPolicyResources = (policyId) => {
    const resources = {
      ...
      'AI_INTEGRATION': '• Shaping the Future of Learning: The Role of AI in Education 4.0 (World Economic Forum): https://www3.weforum.org/docs/WEF_Shaping_the_Future_of_Learning_2024.pdf\n• Artificial Intelligence and the Future of Teaching and Learning (U.S. Department of Education): https://www.ed.gov/sites/ed/files/documents/ai-report/ai-report.pdf'
    }
